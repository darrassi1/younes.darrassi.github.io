...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            skills: ["Devops", "Gitlab", "AWS", "Github", "Deploiement", "SQL", "Firebase"],
            projects: ["UbuntuOS Portfolio", "internship management application", "Spa", "football analytics", "Centralized BI Solution for COMMANDE_FOURNISSEUR", "Electrical Pylon Management Application", "e-learning-Angular"],
            interests: ["Software Engineering", "Cloud and Devops", "Infrastructure", "Computer Vision"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">younes@Dell</div>
        ...
        switch (main) {
            ...
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-younes-darrassi, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
